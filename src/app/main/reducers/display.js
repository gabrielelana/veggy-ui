...
export default buildReducer({
  [Action.PomodoroStarted]: (state, action) => ({ timer_id: action.payload.timer_id, pomodoro_id: action.payload.pomodoro_id, ticking: true, isShared: (action.payload.shared_with && action.payload.shared_with.length > 0)}),
